...
class CsAnalyzer extends AbstractFileAnalyzer implements CacheAwareInterface
{
    ...
    {
        $availableStandards = array('custom', 'PEAR', 'PHPCS', 'PSR1', 'PSR2', 'Squiz', 'Zend', 'WordPress', 'Drupal', 'TYPO3CMS', 'TYPO3Flow');
            ...
            ->perFileConfig()
                ...
                ->children()
                    ->scalarNode('tab_width')
                        ...
                        ->attribute('help_inline', 'The number of spaces a tab represents (0 disables tab to space conversion - the default).')
                        ->defaultValue(0)
                    ->end()
                    ->scalarNode('encoding')
                    ...
                    ->enumNode('standard')
                        ->attribute('choices', array(
                            ...
                            'TYPO3CMS' => 'Typo3 CMS Standard',
                            'TYPO3Flow' => 'Typo3 Flow Standard',
                        ))
